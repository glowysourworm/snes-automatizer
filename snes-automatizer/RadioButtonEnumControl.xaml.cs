...
namespace snes_automatizer
{
    public partial class RadioButtonEnumControl : UserControl
    {
        ...
        public static readonly DependencyProperty EnumGroupNameProperty =
            DependencyProperty.Register("EnumGroupName",
                                        typeof(string),
                                        typeof(RadioButtonEnumControl),
                                        new PropertyMetadata(new PropertyChangedCallback(OnEnumGroupNameChanged)));
        ...
        public string EnumGroupName
        {
            get { return (string)GetValue(EnumGroupNameProperty); }
            set { SetValue(EnumGroupNameProperty, value); }
        }
        ...
        private static void OnEnumGroupNameChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            // Nothing to do
        }
